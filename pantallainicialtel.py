...
class PantallaBienvenida(Screen):
    ...
    def build_ui(self):
        ...
        logo = Image(source="Imagen5-Photoroom.png", size_hint=(None, None), size=(dp(120), dp(120)), pos_hint={"center_x": 0.5})
        main_layout.add_widget(logo)
        titulo = Label(text="[b]PETOTECH[/b]", markup=True, font_size=sp(32), color=(0, 0, 0, 1), size_hint_y=None, height=dp(50))
        main_layout.add_widget(titulo)
        subtitulo = Label(text="Tu solución tecnológica para el futuro", font_size=sp(16), color=(0.1, 0.3, 0.7, 1), size_hint_y=None, height=dp(35))
        ...
        copyright_label = Label(text="Copyright © 2025 - PetoTech System", font_size=sp(12), color=(0.3, 0.3, 0.3, 1), size_hint_y=None, height=dp(25))
